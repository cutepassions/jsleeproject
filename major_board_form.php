...
<div id="main_content">
    <div id="join_box">
        <form name="board_form" method="post" action="major_board_insert.php">
            <h2>평가 항목</h2>
            <div class="form id">
            ...
            <div class="clear"></div>
            <div class="form">
                <div class="col1">수강이유</div>
                <div class="col2">
                    <input type="text" name="reason">
                </div>
            </div>
            <div class="form">
                <div class="col1">장점</div>
                <div class="col2">
                    <input type="text" name="advan">
                </div>
            </div>
            <div class="form">
                <div class="col1">단점</div>
                <div class="col2">
                    <input type="text" name="disadvan">
                </div>
            </div>
            <div class="clear"></div>
            ...
            <div class="buttons">
                <a class="primary_btn tr-bg" onclick="check_input()"><span>평가완료</span></a>
            </div>
        </form>
    </div> <!-- join_box -->
</div> <!-- main_content -->
